defmodule AsyncTestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AsyncTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AsyncTestWeb.Gettext, "errors", msg, opts)
    end
  end
